        ...
        <div className="space-y-10">
          {timelineData.map((item, i) => (
            ...
            >
              ...
              {/* Content Card with centered text contents */}
              <div className="flex-1 space-y-4">
                ...
                <div
                  className="paper-card p-5 sm:p-7 relative w-full flex flex-col items-center text-center"
